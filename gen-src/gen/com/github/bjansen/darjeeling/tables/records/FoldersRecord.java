...
public class FoldersRecord extends UpdatableRecordImpl<FoldersRecord> implements Record6<Integer, String, Integer, DateTime, DateTime, Byte> {

	private static final long serialVersionUID = 1718537203;
	 ...
	 */
	public void setIsExpanded(Byte value) {
		setValue(5, value);
	}
	 ...
	 */
	@Override
	public Row6<Integer, String, Integer, DateTime, DateTime, Byte> fieldsRow() {
	 ...
	 */
	@Override
	public Row6<Integer, String, Integer, DateTime, DateTime, Byte> valuesRow() {
	 ...
	 */
	@Override
	public FoldersRecord values(Integer value1, String value2, Integer value3, DateTime value4, DateTime value5, Byte value6) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public FoldersRecord(Integer id, String name, Integer userId, DateTime createdAt, DateTime updatedAt, Byte isExpanded) {
		super(Folders.folders);
